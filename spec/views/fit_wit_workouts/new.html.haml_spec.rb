...
describe "fit_wit_workouts/new.html.haml" do
  before(:each) do
    assign(:fit_wit_workout, stub_model(FitWitWorkout,
      :name => "MyString",
  ...
  it "renders new fit_wit_workout form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => fit_wit_workouts_path, :method => "post" do
