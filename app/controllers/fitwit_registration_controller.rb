...
class FitwitRegistrationController < ApplicationController
  # must change !!
  #ssl_required  :consent, :save_order, :payment, :pay, :release_and_waiver_of_liability, :terms_of_participation
