  ...
  def video(camper)
    ...
    content_tag :div, class: "full_page" do
      content_tag :video, width: 640, height: 480, poster: png, controls: "controls" do
        ...
        content_tag(:object, id: "flash_fallback_1", class: 'vjs-flash-fallback', width: '640', height: '480', type: 'application/x-shockwave-flash', data: 'http://releases.flowplayer.org/swf/flowplayer-3.2.1.swf') do
