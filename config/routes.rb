...
Cba::Application.routes.draw do
  ...
  get "my_fit_wit/exercise_details"

  get "my_fit_wit/update"

  get "my_fit_wit/past_fitnesscamps"

  get "my_fit_wit/camp_exercise_progress"
