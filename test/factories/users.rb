...
Factory.define :user_without_member, class: User do |u|
  u.email 'user@foodomain.com'
  u.name 'user'
  u.roles_mask 1
  u.first_name "Scaben"
  u.last_name "Jackson"
...
Factory.define :user_with_membership, class: User do |u|
  u.name 'user_with_membership'
  u.roles_mask 1
  u.first_name "Scaben"
  u.last_name "Jackson"
  u.email "jack@fit.com"
  u.gender 1
  u.occupation "Scientist"
  u.company "USAF"
  u.street_address1 "1050 Wilderness"
